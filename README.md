...
so you see *"🔍 Looking at the page… 👆 Clicking…"* as it happens and the reply types itself
in — no dead spinner. The current page snapshot is pre-loaded into the prompt so the agent can
